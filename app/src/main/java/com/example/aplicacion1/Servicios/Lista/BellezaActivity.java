...
public class BellezaActivity extends AppCompatActivity {

    private Button botonVolver;

    RecyclerView listaBelleza;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        botonVolver.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(BellezaActivity.this, ServiciosFragment.class);
                startActivity(intent);
                finish();
            }
        });

        listaBelleza = findViewById(R.id.listaBelleza);
        // Inicializar Firebase Firestore
        db = FirebaseFirestore.getInstance();
        // Configurar el RecyclerView
        listaBelleza.setLayoutManager(new LinearLayoutManager(this));
        productos = new ArrayList<>();
        adapter = new Adapter(this, productos);
        listaBelleza.setAdapter(adapter);
