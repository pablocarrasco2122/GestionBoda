...
public class CaterinActivity extends AppCompatActivity {

    private Button botonVolver;

    RecyclerView listaCaterin;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        botonVolver.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(CaterinActivity.this, ServiciosFragment.class);
                startActivity(intent);
                finish();
            }
        });

        listaCaterin = findViewById(R.id.listaCaterin);
        // Inicializar Firebase Firestore
        db = FirebaseFirestore.getInstance();
        // Configurar el RecyclerView
        listaCaterin.setLayoutManager(new LinearLayoutManager(this));
        productos = new ArrayList<>();
        adapter = new Adapter(this, productos);
        listaCaterin.setAdapter(adapter);
