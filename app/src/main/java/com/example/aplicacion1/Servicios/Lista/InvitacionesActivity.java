    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        botonVolver.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(InvitacionesActivity.this, ServiciosFragment.class);
                startActivity(intent);
                finish();
            }
        });

        listaInvitaciones = findViewById(R.id.listaInvitaciones);
        // Inicializar Firebase Firestore
        db = FirebaseFirestore.getInstance();
        // Configurar el RecyclerView
        listaInvitaciones.setLayoutManager(new LinearLayoutManager(this));
        productos = new ArrayList<>();
        adapter = new Adapter(productos);
        listaInvitaciones.setAdapter(adapter);
