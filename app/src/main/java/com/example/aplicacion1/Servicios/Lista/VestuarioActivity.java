    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        botonVolver.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(VestuarioActivity.this, ServiciosFragment.class);
                startActivity(intent);
                finish();
            }
        });

        listaVestuario = findViewById(R.id.listaVestuario);
        // Inicializar Firebase Firestore
        db = FirebaseFirestore.getInstance();
        // Configurar el RecyclerView
        listaVestuario.setLayoutManager(new LinearLayoutManager(this));
        productos = new ArrayList<>();
        adapter = new Adapter(this, productos);
        listaVestuario.setAdapter(adapter);
